...
function pushtape_theme_form($form, &$form_state) {
  ...
  foreach(system_rebuild_theme_data() as $theme) {
    if (!in_array($theme->name, array( 'omega', 'navin', 'garland', 'alpha', 'tao', 'rubik', 'test_theme', 'update_test_basetheme', 'update_test_subtheme', 'block_test_theme', 'stark', 'seven', 'pushtape_maintenance', 'omega-html5', 'omega-xhtml', 'alpha-html5', 'alpha-xhtml'))) {
